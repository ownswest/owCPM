...
function run()
  ...
  if menu==3 then
    ...
    gg.alert("Set The Name To 'owns' In 15 Seconds")
    fifteenSec()
  ...
  if menu==7 then
    ...
    gg.setVisible(false)
    gg.toast('#FFFFFF In 5 Seconds 1/4')
    fiveSec()
  ...
  if menu==8 then
    ...
    gg.toast("Select #2 Bumper In 5 Seconds")
    fiveSec()
  ...
  if menu==9 then
    ...
    gg.toast("Set INCLINE To A Maximum In 5 Seconds 1/4")
    fiveSec()
  ...
  if menu==10 then
    ...
    gg.toast("Set The Angle To 30 In 5 Seconds 1/2")
    fiveSec()
