...
function run()
  ...
  if menu==4 then
    ...
    gg.toast('Buy The #18 Vehicles In 5 Seconds')
    gg.setVisible(false)
  ...
  if menu==7 then
    ...
    gg.setVisible(false)
    gg.toast('#FFFFFF In 10 Seconds 1/4')
    tenSec()
    gg.searchNumber('1',gg.TYPE_FLOAT)
    gg.setVisible(false)
    gg.toast('#000000 In 5 Seconds 2/4')
    fiveSec()
    gg.refineNumber('0;0;0',gg.TYPE_FLOAT)
    gg.sleep(100)
    gg.refineNumber('0;0;0',gg.TYPE_FLOAT)
    gg.setVisible(false)
    gg.toast('#FFFFFF In 5 Seconds 3/4')
    fiveSec()
    gg.refineNumber('1;1;1',gg.TYPE_FLOAT)
    gg.sleep(100)
    gg.refineNumber('1;1;1',gg.TYPE_FLOAT)
    gg.setVisible(false)
    gg.toast('#000000 In 5 Seconds 4/4')
    fiveSec()
    gg.refineNumber('0;0;0',gg.TYPE_FLOAT)
    gg.sleep(100)
    gg.refineNumber('0;0;0',gg.TYPE_FLOAT)
  ...
  if menu==8 then
    ...
    gg.toast("Select #2 Bumper In 10 Seconds")
    tenSec()
    gg.searchNumber("1",gg.TYPE_DWORD)
    gg.setVisible(false)
    gg.toast("Select #3 Bumper In 5 Seconds")
    fiveSec()
    gg.refineNumber("2",gg.TYPE_DWORD)
    gg.setVisible(false)
    gg.toast("Select #4 Bumper In 5 Seconds")
    fiveSec()
    gg.refineNumber("3",gg.TYPE_DWORD)
    gg.setVisible(false)
    gg.toast("Press 'X' In 5 Seconds")
    fiveSec()
  ...
  if menu==9 then
    ...
    gg.toast("Set INCLINE To A Maximum In 10 Seconds 1/4")
    tenSec()
    gg.searchNumber('-10', gg.TYPE_FLOAT)
    gg.toast("Set INCLINE To A Minimum In 5 Seconds 2/4")
    fiveSec()
    gg.refineNumber('0')
    gg.sleep(100)
    gg.refineNumber('0')
    gg.toast("Set INCLINE To A Maximum In 5 Seconds 3/4")
    fiveSec()
    gg.refineNumber('-10')
    gg.sleep(100)
    gg.refineNumber('-10')
    gg.toast("Set INCLINE To A Minimum In 5 Seconds 4/4")
    fiveSec()
    gg.refineNumber('0')
    gg.sleep(100)
    gg.refineNumber('0')
  ...
  if menu==10 then
    ...
    gg.toast("Set The Angle To 30 In 10 Seconds 1/2")
    tenSec()
    gg.searchNumber('30', gg.TYPE_FLOAT)
    gg.toast("Set The Angle To 60 In 5 Seconds 2/2")
    fiveSec()
    gg.refineNumber('60')
    gg.sleep(100)
    gg.refineNumber('0')
